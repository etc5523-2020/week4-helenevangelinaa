...
title: "More artcile"
description: |
  Some additional information about the Bob Ross's paintings
---
...
```{r timevis, fig.cap = "Timeline of \"The Joy of Painting\" from Season 1-7.", include=FALSE}
data <- df %>% 
  group_by(SEASON) %>% 
...
```{r barplot, fig.height = 8, fig.cap="Percentage containing each element", include=FALSE}
df_longer <- df %>% 
